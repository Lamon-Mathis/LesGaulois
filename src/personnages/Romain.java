...
//	}
	...
	private void donnerEquipement(Equipement equipement) {
		...
		System.out.println(LE_SOLDAT + this.getNom() + " s'�quipe avec un " + equipement.toString());
		this.nbEquipement++;
	}
	...
	public void sEquiper(Equipement equipement) {
		switch (nbEquipement) {
		case 2:
			System.out.println(LE_SOLDAT + this.getNom() + " est d�j� bien prot�g� !");

			break;
		case 1:
			if (this.equipements[0] == equipement) {
				System.out.println(LE_SOLDAT + this.getNom() + " poss�de d�j� un " + (this.equipements[0]).toString());
			} else
